...
```html
Press <dt-keyboard-shortcut :screen-reader-text="'Press Ctrl and F5'" shortcut="Ctrl + F5" /> to hard refresh the page.
```

### Accessibility

Keyboard shortcuts should be visible to sighted users and made available to assistive technology.
This keyboard shortcut component itself, is purely visual.

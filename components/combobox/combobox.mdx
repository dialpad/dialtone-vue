...
The **input** slot contains the input element that controls the items in the list.

The **list** contains a list of items to show in the context of the input's value.
...
The list item should be compatible with keyboard navigation. The combobox provides a `getItemProps` method
...
emit a **select** event with the index of the currently highlighted list item.

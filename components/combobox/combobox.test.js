...
describe('Dialtone Vue Combobox tests', function () {
  ...
  beforeEach(function () {
    ...
    listeners = { select: selectStub, escape: escapeStub };
    _mountWrapper();
    _setChildWrappers();
  });
  ...
  describe('Interactivity Tests', function () {
    describe('When "Enter" key is pressed but no item is highlighted', function () {
      ...
      it('should not call listener', async function () { assert.isFalse(selectStub.called); });
    ...
    describe('When "Enter" key is pressed and item is highlighted', function () {
      ...
      it('should call listener', async function () { assert.isTrue(selectStub.called); });
    ...
    describe('When "Esc" key is pressed', function () {
      ...
      it('should call listener', async function () { assert.isTrue(escapeStub.called); });

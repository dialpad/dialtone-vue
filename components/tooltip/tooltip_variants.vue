<template>
  ...
  >
    <!-- Arrow Description -->
    <div
      v-for="(rowDirection, i) in TOOLTIP_TIPPY_DIRECTIONS"
      :key="i"
...
import { TOOLTIP_TIPPY_DIRECTIONS } from './tooltip_constants';
...
export default {
  ...
  data () {
    return {
      TOOLTIP_TIPPY_DIRECTIONS: sliceIntoChunks(TOOLTIP_TIPPY_DIRECTIONS, 3),

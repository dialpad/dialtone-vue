...
The tiptap Mention plugin is apt for our use case of mentioning users/ channels within the editor.
...
more details can be seen here: <https://tiptap.dev/api/utilities/suggestion> .

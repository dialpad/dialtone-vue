...
You may access the master list of supported emojis and all emoji metadata by importing the following module:
...
```js
EmojiJson['1f600'].name // returns "grinning face"

// when skintone, the unicode strings for the emoji and skin tone are separated by a -
EmojiJson['1f482-1f3fb'].shortname // returns ":guard_tone1:"
```

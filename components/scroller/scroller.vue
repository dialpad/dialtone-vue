    ...
    updateVisibleItems (checkItem, checkPositionDiff = false) {
      ...
      if (!count) {
        ...
        if (itemSize === null) {
          ...
          // Fixed size mode
          startIndex = ~~(scroll.start / itemSize * 1);
          const remainer = startIndex % 1;
          startIndex -= remainer;
          endIndex = Math.ceil(scroll.end / itemSize * 1);
          visibleStartIndex = Math.max(0, Math.floor((scroll.start - beforeSize) / itemSize * 1));
          visibleEndIndex = Math.floor((scroll.end - beforeSize) / itemSize * 1);
          ...
          totalSize = Math.ceil(count / 1) * itemSize;
        }
      }

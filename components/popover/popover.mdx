...
- The popover may optionally have a header / footer.
  - Header / Footer is always placed at the top and bottom of the popover frame respectively.
  - Header / Footer will remain in place as the main content is scrolled.
- Setting the max height of the popover will make the content scrollable. Otherwise the popover will size to fit it's content

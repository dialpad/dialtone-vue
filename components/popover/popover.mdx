...
You can find the recommended way to use the popover in the [documentation](https://popper.js.org/docs/v2/performance/#attaching-elements-to-the-dom)
...
- Other popover examples: [Spectrum. Popover](https://spectrum.adobe.com/page/popover/),
[Polaris. Popover](https://polaris.shopify.com/components/overlays/popover),
[Atlassian Design System. Popover](https://atlassian.design/components/inline-dialog/examples),
Carbon Components in Vue.js
[overflowmenu](https://vue.carbondesignsystem.com/?path=/story/components-cvoverflowmenu--default),
[dropdown](https://vue.carbondesignsystem.com/?path=/story/components-cvdropdown--default)

import{c as L}from"./storybook_utils-dy5aucTw.js";import{b as h}from"./stack_constants-45i7xhSZ.js";import{D as b}from"./description_list-xAfivImm.js";import{s as S,o as $,b as x}from"./vue.esm-bundler-qY5SvxH_.js";import{_ as w}from"./_plugin-vue_export-helper-x3n3nnut.js";const y={name:"DtDescriptionListDefault",components:{DtDescriptionList:b}};function q(t,a,j,F,O,A){const C=S("dt-description-list");return $(),x(C,{gap:t.$attrs.gap,items:t.$attrs.items,direction:t.$attrs.direction,"term-class":t.$attrs.termClass,"description-class":t.$attrs.descriptionClass},null,8,["gap","items","direction","term-class","description-class"])}const z=w(y,[["render",q]]);y.__docgenInfo={displayName:"DtDescriptionListDefault",exportName:"default",description:"",tags:{},sourceFiles:["/home/runner/work/dialtone-vue/dialtone-vue/components/description_list/description_list_default.story.vue"]};const T={items:{control:"object",table:{defaultValue:{summary:"{ term: string, description: string }[]"}}},direction:{options:["row","column"],control:{type:"radio"}},gap:{options:h,control:{type:"select"}}},v={direction:"row",gap:"400",items:[{term:"Customer Intent",description:"Hello, I'm looking to return my TV"},{term:"Reason",description:"Refound"},{term:"Country",description:"England"},{term:"Random",description:"Value"}]},R={items:[{term:"Customer Intent",description:`Lorem ipsum dolor sit amet, consectetur adipiscing elit,
...
//# sourceMappingURL=description_list.stories-iik37ZQm.js.map

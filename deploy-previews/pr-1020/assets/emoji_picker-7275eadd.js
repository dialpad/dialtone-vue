...
`,e.jsxs(t.p,{children:["For the ",e.jsx(t.code,{children:"withPopover"})," variant it is necessary to provide the ",e.jsx(t.code,{children:'initial-focus-element="#searchInput"'})," prop to the ",e.jsx(t.code,{children:"dt-popover"}),` component.
...
/>
`})})]})}}export{z as default};
//# sourceMappingURL=emoji_picker-7275eadd.js.map

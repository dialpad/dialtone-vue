...
>
  ...
  <template #bottom>
    <div class="d-d-flex d-ai-center d-mtn6">
      ...
      `}},a11y:{config:{rules:[{id:"aria-allowed-attr",enabled:!1},{id:"duplicate-id",enabled:!1}]}}};const s=O.bind({});s.args={avatarInitials:"NW",avatarColor:"orange-500",avatarSize:"lg",presence:"busy",onGroupContactClick:o("click: clickable group contact"),onMarkAsSpam:o("click: mark this contact as spam"),onConnectToARecord:o("click: connect to a record")};s.parameters={docs:{source:{code:`
...
`}},controls:{disable:!0},actions:{disable:!0},options:{showPanel:!1},a11y:i.parameters.a11y};var v,b,y;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`(args, {
  argTypes
}) => createTemplateFromVueFile(args, argTypes, DtRecipeContactInfoDefaultTemplate)`,...(y=(b=i.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};var _,h,g;s.parameters={...s.parameters,docs:{...(_=s.parameters)==null?void 0:_.docs,source:{originalSource:`(args, {
  argTypes
}) => createTemplateFromVueFile(args, argTypes, DtRecipeContactInfoVariantsTemplate)`,...(g=(h=s.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};const B=["argsData","argTypesData","Default","Variants"],et=Object.freeze(Object.defineProperty({__proto__:null,Default:i,Variants:s,__namedExportsOrder:B,argTypesData:I,argsData:w,default:U},Symbol.toStringTag,{value:"Module"}));export{et as C};
//# sourceMappingURL=contact_info.stories-51007be8.js.map

...
`,e.jsx(s,{children:e.jsx(a,{id:"components-root-layout--default"})}),`
...
`,e.jsx(s,{children:e.jsx(a,{id:"components-root-layout--sticky-header"})}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-html",children:`<template>
...
This can be changed via the `,e.jsx(t.code,{children:"responsiveBreakpoint"})," prop if desired."]})]})}}export{L as default};
//# sourceMappingURL=root_layout-1ef3ed1c.js.map

...
`,e.jsx(s,{children:e.jsx(a,{of:LayoutStories.Default})}),`
...
`,e.jsx(s,{children:e.jsx(a,{of:LayoutStories.StickyHeader})}),`
`,e.jsx(t.pre,{children:e.jsx(t.code,{className:"language-html",children:`<template>
...
This can be changed via the `,e.jsx(t.code,{children:"responsiveBreakpoint"})," prop if desired."]})]})}}export{R as default};
//# sourceMappingURL=root_layout-a35a6d71.js.map

  ...
  >
    ...
    <template #bottom>
      <div class="d-d-flex d-ai-center d-mtn6">
        ...
        `}},a11y:{config:{rules:[{id:"aria-allowed-attr",enabled:!1},{id:"duplicate-id",enabled:!1}]}}}},s={render:B,args:{avatarInitials:"NW",avatarColor:"orange-500",avatarSize:"lg",avatarIcon:"user",presence:"busy",onGroupContactClick:d("click: clickable group contact"),onMarkAsSpam:d("click: mark this contact as spam"),onConnectToARecord:d("click: connect to a record")},parameters:{docs:{source:{code:`
...
}`,...(g=(_=s.parameters)==null?void 0:_.docs)==null?void 0:g.source}}};const O=["argsData","argTypesData","Default","Variants"],et=Object.freeze(Object.defineProperty({__proto__:null,Default:i,Variants:s,__namedExportsOrder:O,argTypesData:A,argsData:I,default:$},Symbol.toStringTag,{value:"Module"}));export{et as C,i as D,s as V};
//# sourceMappingURL=contact_info.stories-328c48bb.js.map

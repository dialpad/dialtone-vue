import{D as M}from"./banner-G4l-KHw3.js";import{D as F}from"./button-ux2tnS3y.js";import{D as N}from"./icon-pX31dgl5.js";import{n as V}from"./_plugin-vue2_normalizer-XBmYDgEh.js";import{c as K}from"./storybook_utils-XrTpeJKJ.js";import{b as u,c}from"./notice.stories-9nLisBPQ.js";const W={name:"BannerDefault",components:{DtBanner:M,DtButton:F,DtIcon:N},props:{show:{type:Boolean,default:!1}},data(){return{displayBanner:this.show}},computed:{shouldInvertButton(){return this.$attrs.kind==="base"||this.$attrs.kind==="error"||this.$attrs.kind==="info"},isInverted(){return this.$attrs.important&&this.shouldInvertButton},buttonKind(){return this.isInverted?"inverted":"muted"},linkClass(){return this.isInverted?"d-link--inverted":"d-link--muted"},buttonCloseProps(){return{...this.$attrs.closeButtonProps,kind:this.$attrs.buttonKind,ariaLabel:"Close"}}}};var E=function(){var e=this,a=e._self._c;return a("div",[a("dt-button",{directives:[{name:"show",rawName:"v-show",value:!e.displayBanner,expression:"!displayBanner"}],on:{click:function(g){e.displayBanner=!0}}},[e._v(" Click to show! ")]),a("dt-banner",{directives:[{name:"show",rawName:"v-show",value:e.displayBanner,expression:"displayBanner"}],class:{"d-ps-sticky":e.show},attrs:{kind:e.$attrs.kind,title:e.$attrs.title,"title-id":e.$attrs.titleId,"content-id":e.$attrs.contentId,important:e.$attrs.important,pinned:e.$attrs.pinned,"hide-close":e.$attrs.hideClose,"close-button-props":e.buttonCloseProps,"hide-icon":e.$attrs.hideIcon,"background-image":e.$attrs.backgroundImage,"background-size":e.$attrs.backgroundSize,"dialog-class":e.$attrs.dialogClass,"visually-hidden-close":e.$attrs.visuallyHiddenClose,"visually-hidden-close-label":e.$attrs.visuallyHiddenCloseLabel},on:{close:function(g){e.displayBanner=!1,e.$attrs.onClose(g)}}},[e.$attrs.default?a("span",{domProps:{innerHTML:e._s(e.$attrs.default)}}):a("span",[e._v(" Message body with "),a("a",{staticClass:"d-link",class:e.linkClass,attrs:{href:"#"}},[e._v("a link")]),e._v(". ")]),e.$attrs.action?a("template",{slot:"action"},[a("dt-button",{attrs:{kind:e.buttonKind,importance:"outlined"},on:{click:e.$attrs.onClick}},[e._v(" "+e._s(e.$attrs.action)+" ")])],1):e._e(),e.$attrs.icon?a("template",{slot:"icon"},[a("dt-icon",{attrs:{name:e.$attrs.icon}})],1):e._e(),e.$attrs.titleOverride?a("template",{slot:"titleOverride"},[a("span",{domProps:{innerHTML:e._s(e.$attrs.titleOverride)}})]):e._e()],2)],1)},j=[];E._withStripped=!0;var p=V(W,E,j,!1,null,null,null,null);p.options.__file="/home/runner/work/dialtone-vue/dialtone-vue/components/banner/banner_default.story.vue";const q=p.exports;p.exports.__docgenInfo={displayName:"BannerDefault",exportName:"default",description:"",tags:{},props:[{name:"show",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}}],sourceFiles:["/home/runner/work/dialtone-vue/dialtone-vue/components/banner/banner_default.story.vue"]};const A=""+new URL("dialpad-gradient-TIMLz1v7.png",import.meta.url).href;c.role={table:{disable:!0}};c.titleId={table:{defaultValue:{summary:"generated unique ID"}}};c.contentId={table:{defaultValue:{summary:"generated unique ID"}}};u.visuallyHiddenCloseLabel="Close Banner";const R={title:"Components/Banner",component:M,args:u,argTypes:c,excludeStories:/.Data$/},t=(m,{argTypes:e})=>K(m,e,q),r={render:t,args:{title:"Optional title",action:"Action",kind:"base"},parameters:{percy:{args:{show:!0}}}},n={render:t,args:{...r.args,kind:"error"},parameters:r.parameters},s={render:t,args:{...r.args,kind:"info"},parameters:r.parameters},o={render:t,args:{...r.args,kind:"success"},parameters:r.parameters},i={render:t,args:{...r.args,kind:"warning"},parameters:r.parameters},l={render:t,args:{...r.args,pinned:!0},parameters:r.parameters},d={render:t,args:{...r.args,backgroundImage:A,backgroundSize:"contain",title:"",action:"",hideIcon:!0,dialogClass:"d-fc-neutral-white",default:"The power of Dialpad. On your desktop"},parameters:r.parameters};var f,h,k;r.parameters={...r.parameters,docs:{...(f=r.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: Template,
  args: {
  ...
  parameters: Default.parameters
}`,...(y=($=s.parameters)==null?void 0:$.docs)==null?void 0:y.source}}};var w,I,B;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: Template,
  args: {
    ...Default.args,
    kind: 'success'
  ...
  parameters: Default.parameters
}`,...(B=(I=o.parameters)==null?void 0:I.docs)==null?void 0:B.source}}};var C,S,T;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: Template,
  args: {
    ...Default.args,
    kind: 'warning'
...
//# sourceMappingURL=banner.stories-YMV7kTnK.js.map

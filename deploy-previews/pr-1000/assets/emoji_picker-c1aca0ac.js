...
`,e.jsxs(t.p,{children:["The 'Most recently used' tab will always be the first tab in the tabSetLabels array. It will be updated dynamically to be shown if there are or not recently used emojis (",e.jsx(t.code,{children:"recentlyUsedEmojis"})," prop)."]}),`
`,e.jsxs(t.p,{children:["The ",e.jsx(t.code,{children:"skin-tone"})," prop provided to the component should listen to the ",e.jsx(t.code,{children:"skin-tone"})," event emitted by the skin selector button to be updated instantly."]}),`
...
`,e.jsxs(t.p,{children:["When the user search for an emoji, the first emoji in the list will be with hovered style, this allow the user to press ",e.jsx(t.code,{children:"ENTER"})," to select this emoji."]}),`
...
`,e.jsxs(t.p,{children:["From the tabset it is possible to navigate through the tabs with ",e.jsx(t.code,{children:"LEFT"})," and ",e.jsx(t.code,{children:"RIGHT"})," arrows, it will jump again to the input search with ",e.jsx(t.code,{children:"DOWN"})," arrow."]}),`
`,e.jsxs(t.p,{children:["From the emoji list you can navigate through the first emoji of each emoji tabset with ",e.jsx(t.code,{children:"TAB"}),`. If you are on the last emoji tabset (flags), it will jump to the skin tone selector.
You can also navigate through all the emojis with arrow keys. It will detect automatically if there are emojis on the subsequen emoji tabset and it will jump to the desire location.`]}),`
`,e.jsxs(t.p,{children:["In the skin tone selector the user can press ",e.jsx(t.code,{children:"ENTER"})," to open the skin tone selector and select the desire skin tone, it can navigate through with ",e.jsx(t.code,{children:"LEFT"})," and ",e.jsx(t.code,{children:"RIGHT"})," arrows and select with ",e.jsx(t.code,{children:"ENTER"}),`.
...
/>
`})})]})}}export{Y as default};
//# sourceMappingURL=emoji_picker-c1aca0ac.js.map

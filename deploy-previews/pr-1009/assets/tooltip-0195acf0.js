import{B as r,T as l,g as p,c as h,a as s}from"./tippy_utils-e4c34e91.js";import{a as u}from"./storybook_utils-be1af372.js";import{D as c}from"./lazy_show-0b3a0cf0.js";import{n as d}from"./_plugin-vue2_normalizer-2bbd088e.js";const f=[...r],m=300,y={hover:"d-tooltip--hover",show:"d-tooltip--show",inverted:"d-tooltip--inverted",hide:"d-tooltip--hide"},g=[...l];const v={name:"DtTooltip",components:{DtLazyShow:c},props:{id:{type:String,default(){return u()}},fallbackPlacements:{type:Array,default:()=>["auto"]},inverted:{type:Boolean,default:!1},offset:{type:Array,default:()=>[0,-4]},placement:{type:String,default:"top",validator(t){return f.includes(t)}},sticky:{type:[Boolean,String],default:!1,validator:t=>g.includes(t)},contentClass:{type:[String,Object,Array],default:""},message:{type:String,default:""},show:{type:Boolean,default:null},transition:{type:String,default:"fade"},delay:{type:Boolean,default:!0}},emits:["shown","update:show"],data(){return{TOOLTIP_KIND_MODIFIERS:y,tip:null,inTimer:null,isShown:!1,currentPlacement:this.placement}},computed:{tooltipListeners(){return{...this.$listeners,"after-leave":()=>{this.onLeaveTransitionComplete()},"after-enter":()=>{this.onEnterTransitionComplete()}}},tippyProps(){var t,e;return{offset:this.offset,appendTo:(e=(t=this.anchorEl)==null?void 0:t.getRootNode())==null?void 0:e.querySelector("body"),interactive:!1,trigger:"manual",placement:this.placement,sticky:this.sticky,popperOptions:p({fallbackPlacements:this.fallbackPlacements,hasHideModifierEnabled:!0,onChangePlacement:this.onChangePlacement})}}},watch:{tippyProps:{handler:"setProps",deep:!0},show:{handler:function(t){t!==null&&(this.isShown=t)},immediate:!0},isShown(t){t?(this.setProps(),this.tip.show()):this.tip.hide()},sticky(t){this.tip.setProps({sticky:t})}},mounted(){this.tip=h(s(this.$refs.anchor),this.initOptions()),this.isShown&&this.tip.show()},beforeDestroy(){var t;this.tip&&((t=this.tip)==null||t.destroy())},methods:{calculateAnchorZindex(){return this.$el.getRootNode().querySelector('.d-modal[aria-hidden="false"], .d-modal--transparent[aria-hidden="false"]')||this.$el.closest(".d-zi-drawer")?651:400},hasVisibleFocus(){return s(this.$refs.anchor).matches(":focus-visible")},onEnterAnchor(t){if(this.delay)this.inTimer=setTimeout(function(e){return this.triggerShow(e)}.bind(this,t),m);else return this.triggerShow(t)},triggerShow(t){t.type==="focusin"?this.show===null&&this.hasVisibleFocus()&&(this.isShown=!0):this.show===null&&(this.isShown=!0)},onLeaveAnchor(){return clearTimeout(this.inTimer),this.triggerHide()},triggerHide(){this.show===null&&(this.isShown=!1)},onChangePlacement(t){this.currentPlacement=t},onLeaveTransitionComplete(){var t;(t=this.tip)==null||t.unmount(),this.$emit("shown",!1),this.show!==null&&this.$emit("update:show",!1)},onEnterTransitionComplete(){this.$emit("shown",!0),this.show!==null&&this.$emit("update:show",!0)},setProps(){this.tip&&this.tip.setProps&&this.tip.setProps({...this.tippyProps,zIndex:this.calculateAnchorZindex()})},onMount(){this.setProps()},initOptions(){return{contentElement:this.$refs.content.$el,allowHTML:!0,zIndex:this.calculateAnchorZindex(),onMount:this.onMount,...this.tippyProps}}}};var a=function(){var e=this,n=e._self._c;return n("div",{attrs:{"data-qa":"dt-tooltip-container"}},[n("a",{ref:"anchor",attrs:{tabindex:"-1",role:"presentation","data-qa":"dt-tooltip-anchor"},on:{focusin:e.onEnterAnchor,focusout:e.onLeaveAnchor,mouseenter:e.onEnterAnchor,mouseleave:e.onLeaveAnchor,keydown:function(o){return!o.type.indexOf("key")&&e._k(o.keyCode,"esc",27,o.key,["Esc","Escape"])?null:e.onLeaveAnchor.apply(null,arguments)}}},[e._t("anchor")],2),n("dt-lazy-show",e._g({ref:"content",class:["d-tooltip",`d-tooltip__arrow-tippy--${e.currentPlacement}`,{[e.TOOLTIP_KIND_MODIFIERS.inverted]:e.inverted},e.contentClass],attrs:{id:e.id,show:e.isShown&&(!!e.message.trim()||!!e.$slots.default),role:"tooltip","aria-hidden":"false","data-qa":"dt-tooltip",appear:"",transition:e.transition}},e.tooltipListeners),[e._t("default",function(){return[e._v(" "+e._s(e.message)+" ")]})],2)],1)},w=[];a._withStripped=!0;var i=d(v,a,w,!1,null,null,null,null);i.options.__file="/home/runner/work/dialtone-vue/dialtone-vue/components/tooltip/tooltip.vue";const k=i.exports;i.exports.__docgenInfo={displayName:"DtTooltip",description:`A tooltip is a floating label that briefly explains an action, function, or an element.
...
//# sourceMappingURL=tooltip-0195acf0.js.map

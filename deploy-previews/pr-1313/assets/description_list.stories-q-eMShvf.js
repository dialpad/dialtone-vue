import{c as h}from"./storybook_utils-dy5aucTw.js";import{b as L}from"./stack_constants-45i7xhSZ.js";import{D as b}from"./description_list-IEOVZN-Y.js";import{s as S,o as $,b as w}from"./vue.esm-bundler-pH9C34oL.js";import{_ as x}from"./_plugin-vue_export-helper-x3n3nnut.js";const v={name:"DtDescriptionListDefault",components:{DtDescriptionList:b}};function k(t,a,j,F,O,A){const C=S("dt-description-list");return $(),w(C,{gap:t.$attrs.gap,items:t.$attrs.items,direction:t.$attrs.direction,"term-class":t.$attrs.termClass,"description-class":t.$attrs.descriptionClass},null,8,["gap","items","direction","term-class","description-class"])}const q=x(v,[["render",k],["__file","/home/runner/work/dialtone-vue/dialtone-vue/components/description_list/description_list_default.story.vue"]]);v.__docgenInfo={displayName:"DtDescriptionListDefault",exportName:"default",description:"",tags:{},sourceFiles:["/home/runner/work/dialtone-vue/dialtone-vue/components/description_list/description_list_default.story.vue"]};const y={items:{control:"object",table:{defaultValue:{summary:"{ term: string, description: string }[]"}}},direction:{options:["row","column"],control:{type:"radio"}},gap:{options:L,control:{type:"select"}}},T={direction:"row",gap:"400",items:[{term:"Customer Intent",description:"Hello, I'm looking to return my TV"},{term:"Reason",description:"Refound"},{term:"Country",description:"England"},{term:"Random",description:"Value"}]},z={items:[{term:"Customer Intent",description:`Lorem ipsum dolor sit amet, consectetur adipiscing elit,
...
//# sourceMappingURL=description_list.stories-q-eMShvf.js.map

import{a as D}from"./chunk-AY7I2SME-5eb1ab46.js";import{c as m}from"./storybook_utils-1fcbdb2e.js";import{D as l}from"./pagination-efcd7b4f.js";import{u,o as v,b as N,p as $,e,x as o}from"./vue.esm-bundler-735640fd.js";import{_ as h}from"./_plugin-vue_export-helper-c27b6911.js";const f={name:"DtPaginationDefault",components:{DtPagination:l},methods:{getPageNumberAriaLabel(a){return a===this.totalPages?`Last page ${a}`:`Page ${a}`}}};function V(a,y,L,A,w,n){const t=u("dt-pagination");return v(),N(t,{"aria-label":a.$attrs.ariaLabel,"total-pages":a.$attrs.totalPages,"active-page":a.$attrs.activePage,"max-visible":a.$attrs.maxVisible,"prev-aria-label":a.$attrs.prevAriaLabel,"next-aria-label":a.$attrs.nextAriaLabel,"page-number-aria-label":n.getPageNumberAriaLabel,onChange:a.$attrs.onChange},null,8,["aria-label","total-pages","active-page","max-visible","prev-aria-label","next-aria-label","page-number-aria-label","onChange"])}const S=h(f,[["render",V],["__file","/home/runner/work/dialtone-vue/dialtone-vue/components/pagination/pagination_default.story.vue"]]);f.__docgenInfo={displayName:"DtPaginationDefault",exportName:"default",description:"",tags:{},sourceFiles:["/home/runner/work/dialtone-vue/dialtone-vue/components/pagination/pagination_default.story.vue"]};const _={name:"DtPaginationVariants",components:{DtPagination:l},methods:{getPageNumberAriaLabel(a){return`Page ${a}`}}},T={class:"d-divide-y d-divide-purple-400"},C={class:"d-m32"},k=e("p",{class:"d-my16 d-fs-200 d-fw-bold"}," Separator in the end ",-1),B={class:"d-m32"},F=e("p",{class:"d-my16 d-fs-200 d-fw-bold"}," Separator in the beginning ",-1),O={class:"d-m32"},j=e("p",{class:"d-my16 d-fs-200 d-fw-bold"}," Separator on both sides ",-1);function E(a,y,L,A,w,n){const t=u("dt-pagination");return v(),$("div",T,[e("div",C,[k,o(t,{"total-pages":10,"aria-label":"pagination with separator in the end","prev-aria-label":"previous","next-aria-label":"next","page-number-aria-label":n.getPageNumberAriaLabel},null,8,["page-number-aria-label"])]),e("div",B,[F,o(t,{"total-pages":15,"active-page":13,"aria-label":"pagination with separator in the beginning","prev-aria-label":"previous","next-aria-label":"next","page-number-aria-label":n.getPageNumberAriaLabel},null,8,["page-number-aria-label"])]),e("div",O,[j,o(t,{"total-pages":10,"active-page":5,"aria-label":"pagination with separator on both sides","prev-aria-label":"previous","next-aria-label":"next","page-number-aria-label":n.getPageNumberAriaLabel},null,8,["page-number-aria-label"])])])}const I=h(_,[["render",E],["__file","/home/runner/work/dialtone-vue/dialtone-vue/components/pagination/pagination_variants.story.vue"]]);_.__docgenInfo={displayName:"DtPaginationVariants",exportName:"default",description:"",tags:{},sourceFiles:["/home/runner/work/dialtone-vue/dialtone-vue/components/pagination/pagination_variants.story.vue"]};const x={totalPages:5,activePage:1,maxVisible:5,ariaLabel:"pagination",prevAriaLabel:"previous",nextAriaLabel:"next",onChange:D("change")},P={totalPages:{control:{type:"number"}},activePage:{control:{type:"number"}},maxVisible:{control:{type:"number"}},ariaLabel:{control:{type:"text"}},nextAriaLabel:{control:{type:"text"}},prevAriaLabel:{control:{type:"text"}},onChange:{table:{disable:!0}},change:{description:"Page Change event",table:{type:{summary:"event"}}}},z={title:"Components/Pagination",component:l,args:x,argTypes:P,excludeStories:/.*Data$/},M=a=>m(a,S),q=a=>m(a,I),i={render:M,args:{},parameters:{docs:{source:{code:`
  <dt-pagination
...
//# sourceMappingURL=pagination.stories-d2a85387.js.map

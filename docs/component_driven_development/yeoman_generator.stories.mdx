...
We can use the Dialtone Vue [Yeoman](https://yeoman.io/) Generator to initialize a new component within the Dialtone Vue project.
...
is recommended that the name has the following format `HsMyComponent`.

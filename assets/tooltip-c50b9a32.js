import{B as i,T as a,g as r,a as l,c as p}from"./tippy_utils-dcd4636d.js";import{g as h}from"./utils-5c9c602d.js";import{D as c}from"./lazy_show-ac5fd1cd.js";import{n as u}from"./_plugin-vue2_normalizer-2bbd088e.js";const d=[...i],f=300,m={hover:"d-tooltip--hover",show:"d-tooltip--show",inverted:"d-tooltip--inverted",hide:"d-tooltip--hide"},y=[...a];const g={name:"DtTooltip",components:{DtLazyShow:c},props:{id:{type:String,default(){return h()}},fallbackPlacements:{type:Array,default:()=>["auto"]},inverted:{type:Boolean,default:!1},offset:{type:Array,default:()=>[0,-4]},placement:{type:String,default:"top",validator(t){return d.includes(t)}},sticky:{type:[Boolean,String],default:!1,validator:t=>y.includes(t)},contentClass:{type:[String,Object,Array],default:""},message:{type:String,default:""},show:{type:Boolean,default:null},transition:{type:String,default:"fade"},delay:{type:Boolean,default:!0},externalAnchor:{type:String,default:null}},emits:["shown","update:show"],data(){return{TOOLTIP_KIND_MODIFIERS:m,tip:null,inTimer:null,isShown:!1,currentPlacement:this.placement}},computed:{tooltipListeners(){return{...this.$listeners,"after-leave":()=>{this.onLeaveTransitionComplete()},"after-enter":()=>{this.onEnterTransitionComplete()}}},tippyProps(){return{offset:this.offset,interactive:!1,trigger:"manual",placement:this.placement,sticky:this.sticky,popperOptions:r({fallbackPlacements:this.fallbackPlacements,hasHideModifierEnabled:!0,onChangePlacement:this.onChangePlacement})}},anchor(){return this.externalAnchor?document.querySelector(this.externalAnchor):l(this.$refs.anchor)}},watch:{tippyProps:{handler:"setProps",deep:!0},show:{handler:function(t){t!==null&&(this.isShown=t)},immediate:!0},isShown(t){t?(this.setProps(),this.tip.show()):this.tip.hide()},sticky(t){this.tip.setProps({sticky:t})}},mounted(){this.tip=p(this.anchor,this.initOptions()),this.isShown&&this.tip.show()},beforeDestroy(){var t;this.tip&&((t=this.tip)==null||t.destroy())},methods:{calculateAnchorZindex(){return this.$el.getRootNode().querySelector('.d-modal[aria-hidden="false"], .d-modal--transparent[aria-hidden="false"]')||this.$el.closest(".d-zi-drawer")?651:400},hasVisibleFocus(){return this.anchor.matches(":focus-visible")},onEnterAnchor(t){if(this.delay)this.inTimer=setTimeout((function(e){return this.triggerShow(e)}).bind(this,t),f);else return this.triggerShow(t)},triggerShow(t){t.type==="focusin"?this.show===null&&this.hasVisibleFocus()&&(this.isShown=!0):this.show===null&&(this.isShown=!0)},onLeaveAnchor(){return clearTimeout(this.inTimer),this.triggerHide()},triggerHide(){this.show===null&&(this.isShown=!1)},onChangePlacement(t){this.currentPlacement=t},onLeaveTransitionComplete(){var t;(t=this.tip)==null||t.unmount(),this.$emit("shown",!1),this.show!==null&&this.$emit("update:show",!1)},onEnterTransitionComplete(){this.$emit("shown",!0),this.show!==null&&this.$emit("update:show",!0)},setProps(){this.tip&&this.tip.setProps&&this.tip.setProps({...this.tippyProps,zIndex:this.calculateAnchorZindex()})},onMount(){this.setProps()},initOptions(){return{contentElement:this.$refs.content.$el,allowHTML:!0,zIndex:this.calculateAnchorZindex(),onMount:this.onMount,...this.tippyProps}}}};var v=function(){var e=this,n=e._self._c;return n("div",{attrs:{"data-qa":"dt-tooltip-container"}},[e.externalAnchor?e._e():n("span",{ref:"anchor",attrs:{"data-qa":"dt-tooltip-anchor"},on:{focusin:e.onEnterAnchor,focusout:e.onLeaveAnchor,mouseenter:e.onEnterAnchor,mouseleave:e.onLeaveAnchor,keydown:function(o){return!o.type.indexOf("key")&&e._k(o.keyCode,"esc",27,o.key,["Esc","Escape"])?null:e.onLeaveAnchor.apply(null,arguments)}}},[e._t("anchor")],2),n("dt-lazy-show",e._g({ref:"content",class:["d-tooltip",`d-tooltip__arrow-tippy--${e.currentPlacement}`,{[e.TOOLTIP_KIND_MODIFIERS.inverted]:e.inverted},e.contentClass],attrs:{id:e.id,show:e.isShown&&(!!e.message.trim()||!!e.$slots.default),role:"tooltip","aria-hidden":"false","data-qa":"dt-tooltip",appear:"",transition:e.transition}},e.tooltipListeners),[e._t("default",function(){return[e._v(" "+e._s(e.message)+" ")]})],2)],1)},w=[],s=u(g,v,w,!1,null,null,null,null);const P=s.exports;s.exports.__docgenInfo={displayName:"DtTooltip",description:`A tooltip is a floating label that briefly explains an action, function, or an element.
...
//# sourceMappingURL=tooltip-c50b9a32.js.map
